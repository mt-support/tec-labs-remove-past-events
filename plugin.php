 ...
 * Text Domain:       tec-labs-remove-past-events-plus
 *
...
function tribe_extension_remove_past_events_plus() {
	...
	if ( ! class_exists( '\Tribe\Extensions\Remove_Past_Events_Plus\Plugin' ) ) {
		tribe_transient_notice(
			'remove-past-events-plus',
			'<p>' . esc_html__( 'Couldn\'t properly load "The Events Calendar Extension: Remove Past Events Plus" the extension was deactivated.', 'tec-labs-remove-past-events-plus' ) . '</p>',
			[],
